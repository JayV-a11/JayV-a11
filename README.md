...
Desenvolvedor **Fullstack** com mais de **5 anos de experiência** construindo aplicações web e mobile escaláveis. Apaixonado por código limpo, boa UX e soluções que fazem diferença de verdade.
...
- 🌐 Desenvolvo aplicações **web e mobile** do zero — do backend ao layout final
- 📱 Experiência com apps **offline-first** usando React Native e .NET MAUI
- ✅ Defensor de testes — já mantive cobertura acima de **90%** em projetos de produção
- 🔄 Refatoração de código legado para arquiteturas modernas (Vue.js, React, Node.js)
- 🗄️ Modelagem e consulta em bancos relacionais e orientados a grafos (Neo4j)
